          ...
          <div className="hero-content">
            <div className="hero-text">
              ...
              <p>
                ...
                cloud technologies, CI/CD, Docker, Kubernetes, and
                infrastructure.
              </p>
      ...
      <h3>Networking</h3>
        ...
        <section id="projects">
          ...
          <div className="projects-container">
            <div className="project-card">
              ...
              <span>
                React | Docker | GitHub Actions | Kubernetes | AWS
              </span>
            </div>
          ...
          <div className="experience-container">
            <div className="experience-card">
              ...
              <p>
                ...
                GitHub Actions, Kubernetes, AWS, and Infrastructure as
                Code through practical projects and continuous learning.
              </p>
            </div>
            ...
            <div className="experience-card">
              ...
              <p>
                Developing a production-style React portfolio and
                gradually implementing CI/CD, containerization,
                Kubernetes deployment, cloud infrastructure, and
                monitoring.
              </p>
            </div>
          </div>
        ...
        <section id="education">
          ...
          <div className="education-container">
            <div className="education-card">
              ...
              <h4>
                Apex Institute of Management and Science - Rajasthan University
              </h4>
              ...
              <p>
                ...
                computer applications, programming, and information
                technology.
              </p>
            </div>
          </div>
        ...
        <section id="contact">
          ...
          <div className="contact-container">
            <a
              href="mailto:abhinavjain132@gmail.com"
              title="Email"
            >
              <FaEnvelope />
              <span>Email</span>
            ...
            <a
              href="https://www.linkedin.com/in/abhinav-jain-015a9318b"
              target="_blank"
              rel="noreferrer"
              title="LinkedIn"
            >
            ...
            <a
              href="https://github.com/abhinavjain132-sudo"
              target="_blank"
              rel="noreferrer"
              title="GitHub"
            >
